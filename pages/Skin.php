...
class Skin extends \MFF\ppanel\Page {
  ...
  public function getLocalizedName() {
    return I::$itzr->t('mff.ppanel.pages.skin.pageTitle');
  }

  public function isDisplayed($pacc, $srv, $gacc) {
    return in_array('skins', $srv->pageTags);
  }

  public function getHTMLOutput() {
    $out = '<h1>' . I::$itzr->t('mff.ppanel.pages.skin.title') . '</h1>';
    $out .= <<<EOT
<div id="skinPreview"></div>
<script src="js/three.min.js"></script>
<script src="js/OrbitControls.js"></script>
<script src="js/Detector.js"></script>
<script src="js/B3DLoader.js"></script>
<script>
var container;
...
function init() {
  ...
  var loader = new THREE.B3DLoader(manager);
  loader.load('3d/character.b3d', function (object) {
